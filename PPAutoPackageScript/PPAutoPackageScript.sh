...
echo "\033[36;1m请输入版本更新描述(按回车结束) \033[0m"
# 读取用户输入并存到变量里
read parameter
sleep 0.5
method="$parameter"

echo "\033[32m*************************  正在上传蒲公英  *************************  \033[0m"

# 上传IPA到蒲公英
curl -F "file=@${export_ipa_path}/${ipa_name}.ipa" \
-F "uKey=2d47d9d3d1557d035144dad0485217a5" \
-F "_api_key=f1b3f7bd790d11fb12f171022e6a4661" \
-F "updateDescription=${method}" \
https://www.pgyer.com/apiv1/app/upload


echo "\033[32m*************************  上传蒲公英成功  *************************  \033[0m"
