...
{
    if (_skipButton == nil) {
        _skipButton = [UIButton NNHBtnTitle:@"" titileFont:[UIConfigManager fontThemeTextTip] backGround:[[UIColor blackColor] colorWithAlphaComponent:0.5] titleColor:[UIColor whiteColor]];
