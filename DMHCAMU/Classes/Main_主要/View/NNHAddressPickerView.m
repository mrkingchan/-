...
#import "NNHAddressPickerView.h"

@interface NNHAddressPickerView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation NNHAddressPickerView

+ (id)shareInstance
{
    static NNHAddressPickerView *shareInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        shareInstance = [[NNHAddressPickerView alloc] init];
    });
...
- (void)setupChlidView
{
    ...
    // 头部按钮视图
    _topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.nnh_width, NNHTopToolbarH)];
    ...
    for (int i = 0; i <buttonTitleArray.count ; i++)
    {
        ...
        button.frame = CGRectMake(i*(self.nnh_width - 50), 0, 50, NNHTopToolbarH);
    ...
    // pickerView
    self.pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, NNHTopToolbarH, self.nnh_width, 250-NNHTopToolbarH)];
...
{
    NNHAddressPickerView *pickerView = [[NNHAddressPickerView alloc] initWithFrame:superView.bounds];
...
//        _wholeView.backgroundColor = [UIColor yellowColor];
//    }
//    return _wholeView;
//}
