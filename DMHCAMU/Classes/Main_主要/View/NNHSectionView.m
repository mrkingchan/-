...
#import "NNHSectionView.h"

@interface NNHSectionView ()
...
{
    return [NNHSectionView sectionIcon:nil title:title detailTile:detailTitle];
}

+ (instancetype)sectionIcon:(NSString *)icon title:(NSString *)title detailTile:(NSString *)detailTitle
{
    NNHSectionView *sectionView = [[self alloc] init];
