...
//    [manager.disabledToolbarClasses addObject:[NNHSubmitOrderController class]];
//    [manager.disabledToolbarClasses addObject:[NNHMoneyWithdrawController class]];
//    [manager.disabledToolbarClasses addObject:[NNHPayViewController class]];
}

/** 开始定位 */
- (void)startGetLocation
{
    [[NNHLocationHelper sharedInstance] reGeocodeAction];
}
