...
- (NSURLRequest *)buildCustomUrlRequest
{
    ...
    [reParams setObject:@"1" forKey:@"isonline"];
    ...
    [self startWithCompletionBlockWithSuccess:^(YTKBaseRequest *request) {
        ...
        if (cached) {
            if ([self loadCacheWithError:nil]) {
                id cacheData = [self valueForKey:@"cacheString"];
            }
        }*/
        ...
        if ([dic[@"code"]integerValue] == 200 ) { // 请求成功
            ...
            [NNHLoginViewController presentInViewController:[UIViewController currentViewController] withAniamtion:YES andCompletion:nil];
