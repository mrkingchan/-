...
@interface NNHUploadImageBaseApi ()

/** upLoadImage **/
@property (nonatomic, strong) UIImage *upLoadImage;

/** model **/
@property (nonatomic, strong) NNHUploadImageModel *upLoadImageModel;

@end

@implementation NNHUploadImageBaseApi
...
- (id)requestArgument
{
    NSDictionary *dic =@{@"key":[NSString stringWithFormat:@"%@.jpeg",self.upLoadImageModel.dir],
