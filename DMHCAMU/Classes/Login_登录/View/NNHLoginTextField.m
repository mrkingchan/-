...
{
    if (self = [super init]){
        self.textColor = [UIConfigManager colorThemeRed];
...
- (UIButton *)secureButton
{
    if (_secureButton == nil) {
        ...
        [_secureButton setImage:[UIImage imageNamed:@"ic_password_open_eye_login"] forState:UIControlStateNormal];
        [_secureButton setImage:[UIImage imageNamed:@"ic_password_close_eye_login"] forState:UIControlStateSelected];
