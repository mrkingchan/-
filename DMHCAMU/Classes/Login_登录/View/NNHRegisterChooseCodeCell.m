...
{
    if (_codeLabel == nil) {
        _codeLabel = [UILabel NNHWithTitle:@"" titleColor:[UIConfigManager colorThemeWhite] font:[UIConfigManager fontThemeTextDefault]];
    }
    return _codeLabel;
}
...
{
    if (_nameLabel == nil) {
        _nameLabel = [UILabel NNHWithTitle:@"" titleColor:[UIConfigManager colorThemeWhite] font:[UIConfigManager fontThemeTextDefault]];
    }
    return _nameLabel;
}
